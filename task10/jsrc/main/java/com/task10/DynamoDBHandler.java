...
import static com.task10.DynamoDBHandlerUtils.*;
...
public class DynamoDBHandler {
    ...
    protected APIGatewayProxyResponseEvent getItemsFromTables() throws JsonProcessingException {
    ...
    protected APIGatewayProxyResponseEvent getItemsFromReservations() throws JsonProcessingException {
    ...
    public APIGatewayProxyResponseEvent getItemFromTables(String id) {
    ...
    public APIGatewayProxyResponseEvent putItemInTables(String body) throws JsonProcessingException {
    ...
    public APIGatewayProxyResponseEvent putItemInReservations(String body) throws JsonProcessingException {
